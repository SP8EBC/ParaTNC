...
uint32_t davis_parsers_rxcheck (uint8_t *input, uint16_t input_ln, uint16_t *total_packet_received,
								uint16_t *total_packet_missed, uint16_t *resynchronizations,
								uint16_t *packets_in_the_row, uint16_t *crc_errors);
