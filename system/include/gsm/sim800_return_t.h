...
typedef enum sim800_return_t {
	...
	SIM800_RECEIVING_TIMEOUT =
		106, /**< SIM800_RECEIVING_TIMEOUT	Timeout during waiting for GPRS module response, if TCP
				connection is established in the transparent mode this might be also caused by no
