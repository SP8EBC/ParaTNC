...
extern volatile uint8_t sx1262_interrupt_flag;
...
/**
 * Checks if SX1262 radio is currently busy or not using IO pin 14- BUSY located on the chip. Radio
 * is treated as busy also when the SPI bus used to comm with it is also busy on any RX/TX
 * transaction
 * @return
 */
