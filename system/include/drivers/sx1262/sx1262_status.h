...
typedef enum sx1262_status_last_command_t {
	...
	SX1262_LAST_COMMAND_DATA_AVAILABLE_TO_HOST =
		0x2,									/**< SX1262_LAST_COMMAND_DATA_AVAILABLE_TO_HOST */
...
sx1262_api_return_t sx1262_status_get (sx1262_status_chip_mode_t *chip_mode,
									   sx1262_status_last_command_t *last_command_status);

sx1262_api_return_t
sx1262_status_get_device_errors (sx1262_status_chip_mode_t *chip_mode,
								 sx1262_status_last_command_t *last_command_status,
								 uint8_t *errors);
