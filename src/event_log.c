...
const char * event_log_str_main_timesync_periodic	= "TS_PERIOD\0";
...
const char * event_id_to_str(event_log_source_t source, uint8_t event_id)
{
	...
	switch (source) {
		...
		case EVENT_SRC_WX_HANDLER:			 break;
		...
		case EVENT_SRC_GSM_GPRS:			 break;
		case EVENT_SRC_TCPIP:				 break;
		case EVENT_SRC_HTTP_CLIENT:			 break;
		case EVENT_SRC_MODBUS:				 break;
		case EVENT_SRC_UMB:					 break;
		case EVENT_SRC_DRV_ANEMOMETER:		 break;
