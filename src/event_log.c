...
const char * event_log_default						= "__DEFAULT\0";
 ...
 */
const char * event_log_str_aprsis_im_not_ok_last_keepalive = "LAST_KEEPALIVE\0";
const char * event_log_str_aprsis_im_not_ok_last_transmit = "LAST_TRANSMIT\0";
const char * event_log_str_aprsis_warn_auth_failed = "AUTH_FAILED\0";
const char * event_log_str_aprsis_warn_timeout_waiting_auth = "TIMEOUT_AUTH\0";
const char * event_log_str_aprsis_warn_no_hello_message = "NO_HELLO_MSG\0";
const char * event_log_str_aprsis_warn_timeout_waiting_hello_msg = "TIMEOUT_HELLO\0";
const char * event_log_str_aprsis_warn_connect_failed = "CONN_FAIL\0";
const char * event_log_str_aprsis_warn_wrong_state = "WRONG_STATE_TO_CONN\0";
const char * event_log_str_aprsis_warn_dead_keepalive = "DEAD_KEEPALV\0";
const char * event_log_str_aprsis_warn_dead_transmit = "DEAD_TRANSMIT\0";
