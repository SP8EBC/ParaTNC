...
#ifdef STM32L471xx
#define CONFIG_SECTION_FIRST_START 		0x0803F000 	//0x0801E800
#define CONFIG_SECTION_SECOND_START		0x0803F800	//0x0801F000
#define CONFIG_SECTION_DEFAULT_START	0x08040000	//0x0801E000
#else
