...
static const uint8_t
	kiss_nrc_response_subfunction_not_supported[KISS_NRC_RESPONSE_UNKNOWN_SERVICE_LN] = {
		FEND,
		NONSTANDARD,
		KISS_NRC_RESPONSE_UNKNOWN_SERVICE_LN,
		KISS_NEGATIVE_RESPONSE_SERVICE,
...
static const uint8_t
	kiss_nrc_response_incorrect_message_ln_or_format[KISS_NRC_RESPONSE_INCORRECT_MESSAGE_LN] = {
		FEND,
		NONSTANDARD,
...
static const uint8_t
	kiss_nrc_response_security_access_denied[KISS_NRC_RESPONSE_SEC_ACCESS_DENIED_LN] = {
		FEND,
		NONSTANDARD,
...
int kiss_nrc_response_fill_subfunction_not_supported (uint8_t *buffer)
{
	...
	if (buffer != 0x00) {
		memcpy (buffer,
				kiss_nrc_response_subfunction_not_supported,
				KISS_NRC_RESPONSE_UNKNOWN_SERVICE_LN);
...
int kiss_nrc_response_fill_incorrect_message_lenght_or_format (uint8_t *buffer)
{
	if (buffer != 0x00) {
		memcpy (buffer,
				kiss_nrc_response_incorrect_message_ln_or_format,
				KISS_NRC_RESPONSE_INCORRECT_MESSAGE_LN);
...
int kiss_nrc_response_fill_security_access_denied (uint8_t *buffer)
{
	if (buffer != 0x00) {
		memcpy (buffer,
				kiss_nrc_response_security_access_denied,
				KISS_NRC_RESPONSE_OUT_OF_RANGE_LN);
