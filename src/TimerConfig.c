...
void TimerTimebaseConfig (void)
{
	...
	// 	transfers from preload to active registers) when preload registers are enable, as well as
...
void TimerConfig (void)
{
	...
	// 	TIM4->CR1 |= TIM_CR1_CEN;			/* timer powinien byc uruchamiany tylko przy wysylaniu
	// danych */
	TIM5->DIER |= 1;
