...
#define TASKS_LIST(ENTRY)																			\
	...
	ENTRY(	task_one_second,				"task_one_sec",		configMINIMAL_STACK_SIZE, 		NULL,	tskIDLE_PRIORITY + 6, 	task_one_sec_handle)	\
	ENTRY(	task_two_second,				"task_two_sec",		configMINIMAL_STACK_SIZE, 		NULL,	tskIDLE_PRIORITY + 6, 	task_two_sec_handle)	\
	ENTRY(	task_event_serial_sensor,		"tev_serial_wx",		configMINIMAL_STACK_SIZE * 2, 	NULL,	tskIDLE_PRIORITY + 7, 	task_ev_serial_sensor_handle)	\
