...
#define TASKS_LIST(ENTRY)																			\
	...
	ENTRY(	task_event_aprsis_msg_trigger,	"tev_apris_trig",	configMINIMAL_STACK_SIZE, 		NULL,	tskIDLE_PRIORITY + 3, 	task_ev_aprsis_trigger)	\
	...
	ENTRY(	task_fanet,						"task_fanet",		configMINIMAL_STACK_SIZE, 		NULL,	tskIDLE_PRIORITY + 4, 	task_fanet_handle)	\
	ENTRY(	task_one_minute,				"task_one_min",		configMINIMAL_STACK_SIZE * 2, 	NULL,	tskIDLE_PRIORITY + 5, 	task_one_min_handle)	\
	ENTRY(	task_ten_second,				"task_ten_sec",		configMINIMAL_STACK_SIZE, 		NULL,	tskIDLE_PRIORITY + 5, 	task_ten_sec_handle)	\
	ENTRY(	task_one_second,				"task_one_sec",		configMINIMAL_STACK_SIZE, 		NULL,	tskIDLE_PRIORITY + 7, 	task_one_sec_handle)	\
	ENTRY(	task_two_second,				"task_two_sec",		configMINIMAL_STACK_SIZE, 		NULL,	tskIDLE_PRIORITY + 6, 	task_two_sec_handle)	\
	ENTRY(	task_event_serial_sensor,		"tev_serial_wx",		configMINIMAL_STACK_SIZE * 2, 	NULL,	tskIDLE_PRIORITY + 8, 	task_ev_serial_sensor_handle)	\
	ENTRY(	task_event_kiss_rx_done,		"tev_serial_kiss",	configMINIMAL_STACK_SIZE, 		NULL,	tskIDLE_PRIORITY + 8, 	task_ev_serial_kiss_rx_done_handle)	\
