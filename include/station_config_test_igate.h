...
/**
 * Three defines below enables or disabled listed communication drivers. Enabling any of then
 * doesn't means that these are used as a data source automatically. That shall be set in 'DATA
 * SOURCES CONFIG' section.
 */

// #define _UMB_MASTER
// #define _DAVIS_SERIAL
#define _MODBUS_RTU // use Modbus RTU slave devices as a external meteo data source. For more
					// configuration (slave ids, registers...) please look into MODBUS RTU
...
// #define _SYMBOL_WIDE1_DIGI	// uncomment if you want 'little' digi symbol (green star with digit
// 1 overlaid) #define _SYMBOL_HOUSE			// uncomment if you want house symbol #define
// _SYMBOL_RXIGATE		// uncomment if you want rxigate symbol (black diamond with R)
