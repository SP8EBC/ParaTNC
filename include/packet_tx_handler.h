...
uint8_t packet_tx_get_trigger_tcp (
	void); //!< return current value of flags triggering sending via GPRS (api, aprs-is...)
void packet_tx_set_trigger_tcp_weather (
	void); //!< forces weather packet to be sent directly to APRS-IS via GPRS
