...
#define _BATTERY_SCALLING_A		(1000)
...
#define _PT_SENSOR_REFERENCE_RES		CONFIG_DATA_PTSENSOR_RREF_4700
...
#define _BCN_INTERVAL 55	// Own beacon interval in minutes
...
// Transmitting delay
#define _DELAY_BASE 15	// * 50ms. For example setting 10 gives 500msec delay. Maximum value is 20
...
#define _GSM_APRSIS_ADDRES		"server.aprs.tomul.net\0"
