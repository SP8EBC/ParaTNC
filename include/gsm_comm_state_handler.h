...
typedef enum gsm_comm_state_machine_t {
	...
	GSM_COMM_ENGINEERING, //!< GPRS is started but not used for anything
...
void gsm_comm_state_handler (uint8_t engineering_done, uint8_t ntp_done,
							 uint8_t api_log_events_remaining, uint8_t gprs_ready);
