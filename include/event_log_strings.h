...
static const char *event_log_str_main_info_cyclic = "CYCLIC\0";
static const char *event_log_str_main_info_hardault = "Hard fault exception\0";
static const char *event_log_str_main_info_supervisor = "Supervisor fail\0";
static const char *event_log_str_main_error_first_crc_fail =
	"CRC checksum for 1st config area fail\0";
static const char *event_log_str_main_error_second_crc_fail =
	"CRC checksum for 2nd config area fail\0";
 ...
 * Strings for events generated by "packet_tx_handler" sources
 */
static const char *event_log_str_packet_tx_handler_info_sending_wx_frame =
	"Sending WX frame over radio\0";
static const char *event_log_str_packet_tx_handler_info_sending_wx_frame_via_gsm =
	"Sending WX frame to APRS-IS over GPRS\0";
static const char *event_log_str_packet_tx_handler_info_set_counters =
	"Set current counters values\0";

/**
 * Strings for events generated by "drv_anemometer" sources
 *
 */
static const char *event_log_str_drv_anemometer_no_pulses_int_fired =
	"No windspeed pulses from anemometer\0";
static const char *event_log_str_drv_anemometer_excesive_slew_rate =
	"Excessive slew rate in windspeed pulses\0";
static const char *event_log_str_drv_anemometer_uf_conv_not_working =
	"U/f converter for winddir not working\0";
static const char *event_log_str_drv_anemometer_uf_freq_to_hi =
	"U/f converter frequency too high\0";
static const char *event_log_str_drv_anemometer_qf_not_full = "Quality Factor not null\0";

/**
 * Strings for events generated by "gsm gprs"
 */
static const char *event_log_str_tcpip_error_apn_config_missing =
	"APN not configured and not auto detected\0";
static const char *event_log_str_tcpip_warn_async_msg_detected =
	"Asynchronous message from GPRS modem\0";
static const char *event_log_str_tcpip_error_sim_card_status = "Can't communicate with SIM card\0";
static const char *event_log_str_tcpip_warn_not_registered_to_nework =
	"Not registered to GSM network\0";
static const char *event_log_str_tcpip_warn_serial_rx_error = "Serial RX error \0";
static const char *event_log_str_tcpip_reset_serial = "Reinitializing UART\0";
static const char *event_log_str_tcpip_warn_get_network_registration =
	"Fail while try to get network registration\0";
...
static const char *event_log_str_tcpip_initializing_get_network_reg_done =
	"Got network registration info OK\0";
static const char *event_log_str_tcpip_initializing_get_pin_status_done =
	"Got SIM card status OK\0";

static const char *event_log_str_tcpip_get_network_registration =
	"Requesting network registration info\0";
static const char *event_log_str_tcpip_get_imsi = "Requesting IMSI\0";
static const char *event_log_str_tcpip_get_pin_status = "Requesting SIM card status\0";
static const char *event_log_str_tcpip_handshaking = "Handshaking with a modem\0";
static const char *event_log_str_tcpip_powered_on = "Modem powered on\0";

/**
 * Strings for events generated by KISS diagnostics
 */
static const char *event_log_str_kiss_warn_erasing_startup = "Erasing startup config\0";
static const char *event_log_str_kiss_warn_programming_startup = "Programming startup config\0";

/**
 * Strings for events generated by "pwr_save"
 */
static const char *event_log_str_pwr_save_going_sleep = "B+ critically low, going to sleep\0";
static const char *event_log_str_pwr_save_goto_intermediate_sleep = "Going to immediate sleep\0";
static const char *event_log_str_pwr_save_wokenup_rtc_it = "Wokenup - RTC interrupt\0";
static const char *event_log_str_pwr_save_wokenup_after_last = "Wokenup - after last one\0";
static const char *event_log_str_pwr_save_wokenup_exited = "Wokeunp - exited\0";
static const char *event_log_str_pwr_save_switching_mode = "Switching powersaving mode\0";
// EVENTS_PWR_SAVE_SWITCHING_MODE
static const char *event_log_str_pwr_save_state_c0 = "Switched to state C0\0";
static const char *event_log_str_pwr_save_state_c1 = "Switched to state C1\0";
static const char *event_log_str_pwr_save_state_c2 = "Switched to state C2\0";
static const char *event_log_str_pwr_save_state_c3 = "Switched to state C3\0";
static const char *event_log_str_pwr_save_state_m4 = "Switched to state M4\0";
static const char *event_log_str_pwr_save_state_m4a = "Switched to state M4A\0";
static const char *event_log_str_pwr_save_state_i5 = "Switched to state I5\0";
static const char *event_log_str_pwr_save_state_l6 = "Switched to state L6\0";
static const char *event_log_str_pwr_save_state_l7 = "Switched to state L7\0";

/**
 * Strings for events generated by "tcpip"
 */
static const char *event_log_str_tcpip_error_connecting = "Connection failure\0";
static const char *event_log_str_tcpip_error_connecting_no_modem_resp =
	"No response from modem while connecting\0";
 ...
 *
 */
static const char *event_log_str_wx_handler_temperature_int_failed =
	"Internal temperature sensor fail\0";
static const char *event_log_str_wx_handler_temperature_dallas_degraded =
	"Dallas sensor QF degraded\0";
static const char *event_log_str_wx_handler_temperature_dallas_not_avble =
	"Dallas sensor QF not available\0";
static const char *event_log_str_wx_handler_temperature_excesive_slew =
	"Dallas sensor exscesive slew\0";
static const char *event_log_str_wx_handler_temperature_pressure_fail =
	"Pressure sensor comms failure\0";
static const char *event_log_str_wx_handler_temperature_humidity_fail =
	"Humidity pressure comms failure\0";

static const char *event_log_str_wx_handler_error_rte_check_anem_timer_has_been_fired =
	"RTE anemometer timer event counter failed\0";
static const char *event_log_str_wx_handler_error_rte_check_slew_limit =
	"RTE slew limiting event counter failed\0";
static const char *event_log_str_wx_handler_error_rte_check_debouncing =
	"RTE debouncing event counter failed\0";
static const char *event_log_str_wx_handler_error_rte_check_uf_converter_fail =
	"RTE u/f converter malfnc event counter failed\0";
static const char *event_log_str_wx_handler_error_rte_check_windspeed_buffers =
	"RTE windspeed and winddir buffers check failed\0";

/**
 * Strings for events generated by "aprsis" sources
 */
static const char *event_log_str_aprsis_im_not_ok_last_keepalive =
	"Communication critical fail, no keepalive\0";
static const char *event_log_str_aprsis_im_not_ok_last_transmit =
	"Communication critical fail, no transmission\0";
static const char *event_log_str_aprsis_warn_auth_failed = "Passcode authorization fail\0";
static const char *event_log_str_aprsis_warn_timeout_waiting_auth =
	"Timeout while waiting for auth\0";
static const char *event_log_str_aprsis_warn_no_hello_message =
	"Unexpected message while waiting for hello\0";
static const char *event_log_str_aprsis_warn_timeout_waiting_hello_msg =
	"Timeout while waiting for hello\0";
static const char *event_log_str_aprsis_warn_connect_failed = "Connection to server fail\0";
static const char *event_log_str_aprsis_warn_wrong_state =
	"Wrong TCPIP state to connect to server\0";
static const char *event_log_str_aprsis_warn_dead_keepalive =
	"Connection stalled, no keepalive rcvd\0";
static const char *event_log_str_aprsis_warn_dead_transmit =
	"Connection stalled, cannot transmit\0";
static const char *event_log_str_aprsis_connecting = "Connecting to APRS-IS server\0";

/**
 * Strings for events generated by "UMB" sources
 */
static const char *event_log_str_umb_warn_crc_failed_in_received_frame =
	"CRC failure in received frame\0";
static const char *event_log_str_umb_warn_received_frame_malformed = "Frame has malformed struct\0";
static const char *event_log_str_umb_warn_nok_sensor_status_in_get_status_data =
	"Error status returned from sensr by status routine\0";
static const char *event_log_str_umb_warn_nok_sensor_status_in_offline_data =
	"Error status returned by sensor\0";
static const char *event_log_str_umb_error_receiving =
	"RS-485 error while receiving data from sensor\0";
static const char *event_log_str_umb_error_unexp_routine_id =
	"Response for unexpected routine id\0";
static const char *event_log_str_umb_error_quality_factor_not_avail =
	"Quality Factor not available\0";
